...
var html='<div class="weatherItem '+row+'"';if(options.image)html+=' style="background-image: url(http://l.yimg.com/a/i/us/nws/weather/gr/'+feed.item.condition.code+daynight+'.png); background-repeat: no-repeat;"';html+='>';html+='<div class="weatherCity">'+feed.location.city+'</div>';html+='<div class="weatherTemp">'+feed.item.condition.temp+'&deg;</div>';if(options.highlow)html+='<div class="weatherRange">حداکثر دما: '+wf.high+'&deg; حداقل دما: '+wf.low+'&deg;</div>';if(options.wind)html+='<div class="weatherWind">سرعت و جهت باد: '+wd+' '+feed.wind.speed+feed.units.speed+'</div>';if(options.link)html+='<div class="weatherLink"><a target = "_blank" href="'+feed.item.link+'">جزئیات بیشتر</a></div>';html+='</div>';if(row=='odd'){row='even';}else{row='odd';}
